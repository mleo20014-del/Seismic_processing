...
class ProcessingView(QWidget):  # Объявляем экран режима обработки.
    """Отображает каркас режима обработки данных."""

    def __init__(self, config: AppConfig) -> None:  # Принимаем конфигурацию.
        """Инициализирует визуальный каркас режима обработки."""
        ...
        label = QLabel("Режим обработки данных", self)  # Создаём подпись.
