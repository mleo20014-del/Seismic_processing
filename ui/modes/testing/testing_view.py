...
class TestingView(QWidget):  # Объявляем экран режима тестирования.
    """Отображает каркас режима тестирования моделей."""

    def __init__(self, config: AppConfig) -> None:  # Принимаем конфигурацию.
        """Инициализирует визуальный каркас режима тестирования."""
        ...
        label = QLabel("Режим тестирования моделей", self)  # Создаём подпись.
